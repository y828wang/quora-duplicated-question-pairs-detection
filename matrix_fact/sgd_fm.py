        ...
        for epoch in range(1, self.nb_epoch + 1):
            ...
            for x, y in data:
                ...
                if train_count % 50000 == 0:
                    if train_count == 0:
                        print
                        '\ttrain_count: %s, current loss: %.6f' % (train_count, 0.0)
                    else:
                        print
                        '\ttrain_count: %s, current loss: %.6f' % (train_count, train_loss / train_count)
...
sgd = SGD(lr=0.001, adam=True, dropout=0.8, l2=0.00, l2_fm=0.00, task='c', n_components=1, nb_epoch=30,
